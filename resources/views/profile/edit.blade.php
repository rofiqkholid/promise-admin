<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-sm font-semibold text-gray-800 tracking-wide uppercase">My Profile Settings</h2>
        </div>
    </x-slot>
    ...
    <div class="px-6 py-6 max-w-4xl mx-auto space-y-6">
        ...
        <div class="bg-white border border-gray-200">
            <div class="px-5 py-3 bg-gray-50/75 border-b border-gray-200 flex items-center gap-2">
                <div class="w-1 h-4 bg-sky-500"></div>
                <h4 class="text-[10px] font-semibold uppercase tracking-wider text-gray-500">Update Password</h4>
            </div>
            <div class="p-5">
                ...
                <form method="post" action="{{ route('password.update') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            <label class="block text-[10px] font-semibold uppercase tracking-wider text-gray-500 mb-1.5">Current Password</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-semibold uppercase tracking-wider text-gray-500 mb-1.5">New Password</label>
                        ...
                        <div>
                            <label class="block text-[10px] font-semibold uppercase tracking-wider text-gray-500 mb-1.5">Confirm Password</label>
        ...
        <div class="bg-rose-50 border border-rose-200">
            <div class="px-5 py-3 bg-rose-100/50 border-b border-rose-200 flex items-center gap-2">
                ...
                <h4 class="text-[10px] font-semibold uppercase tracking-wider text-rose-800">Danger Zone</h4>
            </div>
                ...
                <div x-show="openDelete" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50" style="display: none;">
                    <div class="bg-white border border-gray-300 w-full max-w-sm" @click.away="openDelete = false">
                        <div class="px-5 py-3 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                            <h3 class="text-xs font-semibold uppercase tracking-wider text-gray-600">Delete Account</h3>
